...
class Day6Solution : Solution(6) {
    ...
    private class Group : InputGroup {

        private val yesAnswers = mutableMapOf<Char, Int>()
        ...
        val questionsWithYesCount: Int
            get() = yesAnswers.size

        val questionsWithAllYesCount: Int
            get() = yesAnswers.count { (_, count) ->
                count == groupSize
            }

    }

    private val groups = inputAsGroups<Group>()

    override fun part1() = groups
        .sumBy { it.questionsWithYesCount }
        .toString()

    override fun part2() = groups
        .sumBy { it.questionsWithAllYesCount }
        .toString()
